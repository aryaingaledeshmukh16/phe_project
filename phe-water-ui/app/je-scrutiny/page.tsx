...
type Applicant = {
  ...
  showAmountAsPerNoOfPlots: boolean | null;
...
const CURRENT_USER_NAME = "Omar Bagwan";

export default function JEScrutinyPage() {
  ...
  const [activeTab, setActiveTab] =
    useState<Tab>("document");

  const [scrutinyAction, setScrutinyAction] =
    useState("Accepted");
  ...
  async function fetchApplications() {
    try {
      ...
      try {
        ...
        throw new Error(
          "API ने valid JSON response दिलेला नाही."
        );
      }
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Applications fetch करताना error आला."
      );
    } finally {
      setLoading(false);
    }
  ...
  async function openHistory(app: Applicant) {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          text || `History API Error: ${response.status}`
        );
      }
      ...
      try {
        ...
        throw new Error(
          "History API ने valid JSON response दिलेला नाही."
        );
      }
      ...
      setHistoryError(
        err instanceof Error
          ? err.message
          : "History fetch करताना error आला."
      );
    } finally {
  ...
  function getNextApplicationStatus(
    ...
    if (
      ...
      return "Send Back to Jr. Engineer";
    }
    ...
    if (
      currentStatus === "document verified"
    ) {
    ...
    if (
      ...
      return "Deputy Engineer Verification Completed";
    }
    ...
    if (
      ...
      return "Due for Payment from Citizen";
    }
  ...
  async function saveScrutiny() {
    ...
    try {
      ...
      alert(
        "Scrutiny details successfully updated."
      );
      ...
      alert(
        err instanceof Error
          ? err.message
          : "Scrutiny update करताना error आला."
      );
    } finally {
      setSaving(false);
    }
  ...
  function getDocumentApiUrl(
    path: string | null,
    download = false
  ) {
    if (!path) return null;

    return `${API_URL}/document?path=${encodeURIComponent(
      path
    )}${
      download
        ? "&download=true"
  ...
  function DocumentRow({
    ...
    const viewUrl =
      getDocumentApiUrl(path, false);

    const downloadUrl =
      getDocumentApiUrl(path, true);
    ...
    <div className="je-page">
      ...
      <header className="je-header-card">
        <div className="je-header-content">
          ...
          <div className="je-heading">
            ...
            <div className="je-project-title">
              बांधकाम परवानगीता ना-हरकत दाखला मिळणेबाबत
            </div>

            <div className="je-role">
              Role: {CURRENT_ROLE}
            </div>

            <div className="je-welcome">
      ...
      <nav className="je-navigation">
        ...
        <button
          ...
          onClick={() =>
            setActiveTab("sentBack")
          }
        >
          Applications sent back by AE
        </button>
          ...
          <section className="je-card">
            ...
            <div className="je-section-title">
              {activeTab === "document"
                ...
                : activeTab === "siteVisit"
                ? "जागेची पाहणी / Site Visit"
                : activeTab === "sentBack"
                ? "Applications sent back by AE"
                : "Application Status"}
            </div>

            <div className="je-count">
                        ...
                        (app, index) => (
                          <tr key={app.id}>
                            ...
                            <td className="je-action-cell">
                              ...
                              <button
                                type="button"
                                className="je-action-btn documents"
                                onClick={() =>
                                  openDocuments(app)
                                }
                              >
                              ...
                              <button
                                type="button"
                                className="je-action-btn history"
                                onClick={() =>
                                  openHistory(app)
                                }
                              >
                            ...
                            <td className="je-center je-bold">
                              {index + 1}
                            </td>

                            <td>
                              <div className="je-date-main">
                                {formatDate(
                                  app.createdDate
                                )}
                              </div>

                              <div className="je-date-time">
                                {new Date(
                                  app.createdDate
                                ).toLocaleTimeString(
                                  "en-IN",
                            ...
                            <td>
                              <span className="je-application-number">
                                {app.applicationNo}
                              </span>
                            </td>

                            <td>
                              <span className="je-applicant-name">
                                {app.fullName}
                              </span>
                            </td>
                            ...
                            <td>
                              {app.approvedLayoutNumber || "-"}
                            </td>

                            <td>
                              {formatDate(
                                app.approvedLayoutDate
                              )}
                            </td>
                ...
                <>
                  ...
                  <div className="details-grid">
                    ...
                    <DetailField
                      ...
                      value={
                        selectedApplication.propertyNumber
                      }
                    />

                    <DetailField
                      label="Layout Address"
                      value={
                        selectedApplication.layoutAddress
                      }
                    />

                    <DetailField
                      label="Approved Layout Number"
                      value={
                        selectedApplication.approvedLayoutNumber
                      }
                    />

                    <DetailField
                      label="Approved Layout Date"
                      value={formatDate(
                        selectedApplication.approvedLayoutDate
                      )}
                    />
                  ...
                  <div className="scrutiny-panel">
                    ...
                    <div className="scrutiny-grid">
                      ...
                      <div className="scrutiny-field">
                        ...
                        <label>
                          Scrutiny Status / पडताळणी
                        </label>

                        <select
                          value={scrutinyAction}
                          onChange={(e) =>
                            setScrutinyAction(
                              e.target.value
                            )
                        ...
                        >
                          ...
                          <option value="Send Back to Jr. Engineer">
                            Send Back to Jr. Engineer
                          </option>
                ...
                <>
                  ...
                  <div className="documents-container">
                    ...
                    <DocumentRow
                      ...
                      title="7/12 / Sat Bara"
                      path={
                        selectedApplication.satBaraPath
                      }
                    />

                    <DocumentRow
                      icon="🗺️"
                      title="Approved Layout Map"
                      path={
                        selectedApplication.approvedLayoutMapPath
                      }
                    />
                    ...
                    <DocumentRow
                      ...
                      title="Geo Tag Photo"
                      path={
                        selectedApplication.geoTagPhotoPath
                      }
                    />
                    ...
                    <DocumentRow
                      ...
                      title="KML File"
                      path={
                        selectedApplication.kmlFilePath
                      }
                    />
                    ...
                    <DocumentRow
                      ...
                      title="Tax NOC"
                      path={
                        selectedApplication.taxNocPath
                      }
                    />
