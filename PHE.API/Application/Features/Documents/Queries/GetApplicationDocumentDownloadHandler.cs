...
{
    public class GetApplicationDocumentDownloadHandler : IGetApplicationDocumentDownloadHandler
    {
        private readonly IDocumentReadService _documentReadService;

        public GetApplicationDocumentDownloadHandler(IDocumentReadService documentReadService)
        {
        ...
        public async Task<IActionResult> HandleAsync(string applicationNo, string documentType, CancellationToken cancellationToken = default)
        {
            ...
            var result = await _documentReadService.GetApplicationDocumentDownloadAsync(applicationNo, documentType, cancellationToken);
